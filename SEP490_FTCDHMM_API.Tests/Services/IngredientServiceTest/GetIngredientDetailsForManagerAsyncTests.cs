...
{
    public class GetIngredientsForManagerAsyncTests : IngredientServiceTestBase
    {
        [Fact]
        public async Task GetIngredientsForManager_ShouldThrowNotFound_WhenCategoryIdsInvalid()
        {
            ...
            await Assert.ThrowsAsync<AppException>(() => Sut.GetIngredientsForManagerAsync(dto));

            IngredientCategoryRepositoryMock.VerifyAll();
        }

        [Fact]
        public async Task GetIngredientsForManager_ShouldCallFilter_WhenCategoryIdsProvided()
        {
            ...
            var result = await Sut.GetIngredientsForManagerAsync(dto);
        ...
        [Fact]
        public async Task GetIngredientsForManager_ShouldNotUseFilter_WhenCategoryIdsEmpty()
        {
            var dto = new IngredientFilterRequest
            {
