...
namespace SEP490_FTCDHMM_API.Application.Services.Implementations
{
    public class DraftRecipeService : IDraftRecipeService
    {
        ...
        public async Task CreateOrUpdateDraftAsync(Guid userId, DraftRecipeRequest request)
        {
        ...
        public async Task<DraftRecipeResponse?> GetDraftAsync(Guid userId)
        {
            var draft = await _draftRecipeRepository.GetDraftByAuthorIdAsync(userId);
            var result = _mapper.Map<DraftRecipeResponse>(draft);
            return result;
        }
    }
}
