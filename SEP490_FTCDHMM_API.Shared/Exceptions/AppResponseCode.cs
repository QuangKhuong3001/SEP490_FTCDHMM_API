namespace SEP490_FTCDHMM_API.Shared.Exceptions
{
    public record AppResponseCode(int StatusCode, string Code)
    {
        ...
        public static readonly AppResponseCode DUPLICATE = new(405, "DUPLICATE");
        ...
        public static readonly AppResponseCode EXISTS = new(415, "EXISTS");
        ...
        public static readonly AppResponseCode MISSING_GENDER = new(421, "MISSING_GENDER");
